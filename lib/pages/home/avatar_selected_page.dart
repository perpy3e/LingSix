            ...
            child: SafeArea(
              child: Column(
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: r.spacing(56)),
                    child: SizedBox(
                      width: double.infinity,
                      height: r.buttonHeight(68),
                      child: ElevatedButton(
                        style: ElevatedButton.styleFrom(
                          ...
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(r.spacing(20)),
                        ...
                        onPressed: () async {
                          ...
                          Navigator.pushReplacement(
                            ...
                            MaterialPageRoute(
                              builder: (_) =>
                                  const HomePage(showReminderPopup: true),
                            ),
                          );
                        },
                        child: Text(
      ...
      child: AnimatedContainer(
        ...
        child: AspectRatio(
          ...
          child: Image.asset(
            ...
            fit: BoxFit.contain,
            errorBuilder: (context, error, stackTrace) =>
                Image.asset(fallbackHeadPath, fit: BoxFit.contain),
          ),
        ),
      ),
    );
